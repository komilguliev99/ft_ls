...
char				*ft_strstr(const char *hstk, const char *need);
...
char				*ft_uitoa_base(unsigned long long int nbr,
						int base, int flag);
char				*ft_strjoin_by(char const *s1, char const *s2,
						char delimiter);
